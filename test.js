...
// have to work on which things????????????????????????????
//1) precipation
//2? temperature


<time from="2020-01-30T00:00:00" to="2020-01-30T01:00:00">
    <symbol number="3" numberEx="3" name="Partly cloudy" var="03n" />
    <precipitation value="0" />
    <windDirection deg="234.2" code="SW" name="Southwest" />
    <windSpeed mps="5.5" name="Moderate breeze" />
    <temperature unit="celsius" value="7" />
    <pressure unit="hPa" value="1010.3" />
</time>

{/* <time from="2020-01-30T00:00:00" to="2020-01-30T03:00:00">
    <symbol number="804" name="overcast clouds" var="04n"></symbol>
    <precipitation></precipitation>
    <windDirection deg="221" code="SW" name="Southwest"></windDirection>
    <windSpeed mps="3.05" unit="m/s" name="Light breeze"></windSpeed>
    <temperature unit="kelvin" value="279.79" min="279.42" max="279.79"></temperature>
    <pressure unit="hPa" value="1009"></pressure>
</time> */}

<time from="2020-01-30T09:00:00" to="2020-01-30T12:00:00">
        <symbol number="800" name="clear sky" var="01d"></symbol>
        <precipitation></precipitation>
        <windDirection deg="306" code="NW" name="Northwest"></windDirection>
        <windSpeed mps="4.16" unit="m/s" name="Gentle Breeze"></windSpeed>
        <temperature unit="celsius" value="13.68" min="13.68" max="13.68"></temperature>
        <pressure unit="hPa" value="1014"></pressure>
</time>
